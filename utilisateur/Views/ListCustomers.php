...
<div class="d-flex align-items-center justify-content-between">
  <a href="../../Dashboard/index.php" class="logo d-flex align-items-center">
    ...
    <span class="d-none d-lg-block">Nova-Teck</span>
  </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!--   <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../../Dashboard/components-alerts.php">
              <i class="bi bi-circle"></i><span>Customer List</span>
            </a>
          </li>
          <li>
            <a href="../../Dashboard/components-accordion.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Forum Section management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../../Dashboard/forms-elements.php">
              <i class="bi bi-circle"></i><span>Messages</span>
            </a>
          </li>
          <li>
            <a href="../../Dashboard/forms-layouts.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Product management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../../Dashboard/tables-general.php">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../../Dashboard/charts-chartjs.php">
              <i class="bi bi-circle"></i><span>Reviews</span>
            </a>
          </li>
          <li>
            <a href="../../Dashboard/charts-apexcharts.php">
              <i class="bi bi-circle"></i><span>Ratings</span>
            </a>
          </li>
        </ul>
      </li> End Charts Nav 
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Order and Delivery</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../../Dashboard/icons-bootstrap.php">
              <i class="bi bi-circle"></i><span>Orders</span>
            </a>
          </li>
          <li>
            <a href="../../Dashboard/icons-remix.php">
...
<li class="nav-item">
  <a class="nav-link collapsed" href="../../Dashboard/users-profile.php">
    <i class="bi bi-person"></i>
    <span>Profile</span>
  </a>
...
<li class="nav-item">
  <a class="nav-link collapsed" href="../../Dashboard/pages-faq.php">
    <i class="bi bi-question-circle"></i>
    <span>F.A.Q</span>
  </a>
...
<li class="nav-item">
  <a class="nav-link collapsed" href="../../Dashboard/pages-contact.php">
...
<div class="container p-5">
      ...
      <!--   <br>
            ...
            <button name="submit-search" id="submit-search" type="submit" title="submit-search"><i class="bi bi-search"></i></button>
            </form>
            </div>End Search Bar -->
        <br>
